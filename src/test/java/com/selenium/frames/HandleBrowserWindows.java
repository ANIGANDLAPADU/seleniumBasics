...
public class HandleBrowserWindows {
	...
	public static void main(String[] args) {
		...
		/*
		 * List <String>windowidsList=new ArrayList(windowIDs); // converted Set --->
		 * List
		 * 
		 ...
		 * 
		 * 
		 * //Swith to child window driver.switchTo().window(childWindowID);
		 * driver.findElement(By.
		 * xpath("//div[@class='d-flex web-menu-btn']//li[1]//a[1]")).click();
		 * 
		 * //Switch to parent window driver.switchTo().window(parentWindowID);
		...
		/*
		 * for(String winid:windowIDs) { String
