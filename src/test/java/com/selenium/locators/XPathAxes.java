...
public class XPathAxes {
	...
	public static void main(String[] args) {
		...
		String text = driver.findElement(By.xpath("//a[contains(text(),'ACC')]/self::a")).getText();
		System.out.println("Self : " + text); // NIIT Ltd

		// Parent - Selects the parent of the current node (always One)
		text = driver.findElement(By.xpath("//a[contains(text(),'ACC')]/parent::td")).getText();// there is no text
																										// for parent,
																										// so it is same
																										// value display
		...
		List<WebElement> childs = driver
				.findElements(By.xpath("//a[contains(text(),'ACC')]/ancestor::tr/child::td"));
		System.out.println("Number of child elements:" + childs.size());//

		// Ancestor - Selects all ancestors (parent, grandparent, etc.)
		text = driver.findElement(By.xpath("//a[contains(text(),'ACC')]/ancestor::tr")).getText();
		...
		List<WebElement> descendants = driver
				.findElements(By.xpath("//a[contains(text(),'ACC')]/ancestor::tr/descendant::*"));
		...
		List<WebElement> followingnodes = driver
				.findElements(By.xpath("//a[contains(text(),'ACC')]/ancestor::tr/following::tr"));
		System.out.println("Number of following nodes:" + followingnodes.size());

		// Following-sibling : Selects all siblings after the current node
		List<WebElement> followingsiblings = driver
				.findElements(By.xpath("//a[contains(text(),'ACC')]/ancestor::tr/following-sibling::tr"));
		...
		List<WebElement> precedings = driver
				.findElements(By.xpath("//a[contains(text(),'ACC')]/ancestor::tr/preceding::tr"));
		System.out.println("Number of preceding nodes:" + precedings.size());

		// preceding-sibling - Selects all siblings before the current node
		List<WebElement> precedingsiblings = driver
				.findElements(By.xpath("//a[contains(text(),'ACC')]/ancestor::tr/preceding-sibling::tr"));
